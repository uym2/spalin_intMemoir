...
class MLTest(unittest.TestCase):
    def test_1(self): 
        ...
        mySolver = ML_solver([T],{'charMatrices':[msa]},{'Q':[Q]},{'phi':0,'nu':0})
    ...
    def test_9(self): 
        ...
        mySolver = ML_solver([T],{'charMatrices':[msa]},{'Q':[Q]},{'phi':0.1,'nu':0})
        #mySolver.az_partition(mySolver.params)
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
    ...
    def test_22(self): 
        ...
        mySolver = ML_solver([T1,T2],{'charMatrices':[msa,msa]},{'Q':[Q,Q]},{'phi':0,'nu':0})
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
        self.assertAlmostEqual(true_nllh,my_nllh,places=5,msg="MLTest: test_22 failed.")
    ...
    def test_23(self): 
        ...
        mySolver = ML_solver([T1,T2],{'charMatrices':[msa,msa]},{'Q':[Q,Q]},{'phi':0.1,'nu':0})
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
        self.assertAlmostEqual(true_nllh,my_nllh,places=5,msg="MLTest: test_23 failed.")
