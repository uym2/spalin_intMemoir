...
class EMTest(unittest.TestCase):
    ...
    def test_1(self): 
        ...
        mySolver = EM_solver([T],{'charMatrices':[msa]},{'Q':[Q]},{'phi':0,'nu':0})
    ...
    def test_9(self): 
        ...
        mySolver = EM_solver([T],{'charMatrices':[msa]},{'Q':[Q]},{'phi':0.1,'nu':0})
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
    ...
    def __test_outllh__(self,T,Q,msa,phi,nu,test_no,give_label=False):
        ...
        mySolver = EM_solver([T],{'charMatrices':[msa]},{'Q':[Q]},{'phi':phi,'nu':nu})
        if give_label:
            currIdx = 0
        ...
        for x in tree_reduced:    
            ...
            msa0[x]= [0]*mySolver.numsites[0]
            tree_str = tree_reduced[x]
            mySolver0 = EM_solver([tree_str],{'charMatrices':[msa0]},{'Q':[Q]},{'phi':phi,'nu':nu})
            ...
            msa1[x] = [-1]*mySolver.numsites[0]
            mySolver1 = EM_solver([tree_str],{'charMatrices':[msa1]},{'Q':[Q]},{'phi':phi,'nu':nu})
    ...
    def test_49(self): 
        ...
        mySolver = EM_solver([T1,T2],{'charMatrices':[msa,msa]},{'Q':[Q,Q]},{'phi':0,'nu':0})
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
        self.assertAlmostEqual(true_nllh,my_nllh,places=5,msg="EMTest: test_49 failed.")
    ...
    def test_50(self): 
        ...
        mySolver = EM_solver([T1,T2],{'charMatrices':[msa,msa]},{'Q':[Q,Q]},{'phi':0.1,'nu':0})
        mySolver.az_partition()
        my_nllh = mySolver.negative_llh()
        self.assertAlmostEqual(true_nllh,my_nllh,places=5,msg="EMTest: test_50 failed.")
